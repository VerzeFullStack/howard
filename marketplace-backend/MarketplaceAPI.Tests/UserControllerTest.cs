...
public class UserControllerTest
{
    ...
    public async Task TestCreateUser()
    {
        ...
        UserController controller = new UserController(mockLogger.Object, mockDbContext.Object);
        var mockHttpContext = new Mock<HttpContext>();
        mockHttpContext.SetupGet(mock => mock.User.Identity.Name).Returns("1");
        mockHttpContext.SetupGet(mock => mock.User.Claims).Returns([new Claim(UserController.DisplayNameClaimType, "test name")]);
